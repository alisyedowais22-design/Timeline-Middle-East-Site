export const CASE_STUDIES_LIST = [
  {
    ...
    quoteRole: 'Fleet Operations Manager — FMCG Sector, UAE',
  },
  {
    id: 'pk-cold-chain',
    region: 'UAE', flag: '🇵🇰', status: 'live',
    ...
    overview: 'Timeline Telematics provided an end-to-end cold chain monitoring solution for a major ice cream distributor in UAE. IoT-based temperature sensors were installed across the fleet, giving operations teams live visibility into temperature conditions at every point in transit.',
    ...
    quoteRole: 'Supply Chain Director — Cold Chain Logistics, UAE',
  },
  {
    id: 'pk-supply-chain',
    region: 'UAE', flag: '🇵🇰', status: 'live',
    ...
    overview: 'Timeline Telematics deployed a comprehensive supply chain monitoring solution for a national logistics provider in UAE. The solution combined fleet tracking with personal/personnel tracking.',
    challenge: 'Managing a large-scale supply chain operation across UAE meant dealing with blind spots at every level. Vehicles were untracked, field personnel had no check-in system, dispatchers had no real-time visibility.',
    features: [
    ...
    quoteRole: 'Operations Director — National Logistics Provider, UAE',
  },
  {
    id: 'me-rta',
